...
/// <summary>
/// DTO for creating nutrition facts
/// Mục đích: Validate data khi create new nutrition record
/// Đặc điểm:
/// - Validation attributes cho mọi field
/// - Required fields: FoodId
/// - Range validation: prevents invalid data
/// - Vietnamese error messages
/// </summary>
public class CreateNutritionFactsDto
{
    [Required]
